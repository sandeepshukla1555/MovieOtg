...
const Footer = () => {
  return (
    <div className='flex flex-col px-4 py-5 bg-zinc-950'>
       <div className='text-center mb-4'>
        <h1 className='text-white text-3xl md:text-5xl mb-2'>MovieOTG</h1>
       ...
       <div className='flex flex-col md:flex-row md:justify-around gap-4'>
         <div>
          <h3 className='text-base md:text-lg font-medium text-sky-400 mb-1'>Context</h3>
         ...
         <div>
          <h3 className='text-base md:text-lg font-medium text-sky-400 mb-1'>Developer Info</h3>
          <ul className='text-sm'>
           <li className='text-zinc-300'>Tv</li>
           <li className='text-zinc-300'>Movie</li>
          </ul>
         ...
         <div>
          <h3 className='text-base md:text-lg font-medium text-sky-400 mb-1'>Developer Contact</h3>
          <ul className='text-sm'>
